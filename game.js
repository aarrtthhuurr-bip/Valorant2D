...
const configuredApiUrl = document
  ...
  ?.trim();
// Tanto o servidor integrado quanto o Live Server oficial do projeto usam a
...
const BLACK_MARKET_GADGETS = Object.freeze([
  ...
  },
  {
    ...
    chargesPerWave: 1,
    cooldown: 30,
    preview: "./assets/black-market/syringe_injection.png",
    staticPreview: "./assets/black-market/syringe_injection.png",
    spriteSheet: {
      src: "./assets/black-market/syringe_injection.png",
      frameWidth: 32,
      frameHeight: 32,
      columns: 7,
      rows: 1,
  ...
  },
  {
    ...
    chargesPerWave: 1,
    cooldown: 22,
    preview: "./assets/black-market/hat_reordered_strip.png",
    staticPreview: "./assets/black-market/hat_reordered_strip.png",
    spriteSheet: {
      src: "./assets/black-market/hat_reordered_strip.png",
      frameWidth: 64,
      frameHeight: 64,
      columns: 16,
      rows: 1,
