const CACHE_VERSION = "valorant2d-shell-v0.9.1-dev.1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest?v=0.9.1-dev.1",
  "./styles.css?v=0.9.1-dev.1",
  "./version-manager.js?v=0.9.1-dev.1",
  "./game.js?v=0.9.1-dev.1",
  "./updates.json?v=0.9.1-dev.1",
